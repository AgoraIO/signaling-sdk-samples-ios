...
For context on this sample, and a full explanation of the essential code snippets used in this project, read [Store channel and user data](https://docs-beta.agora.io/en/signaling/develop/storage?platform=ios)
