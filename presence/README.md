...
For context on this sample, and a full explanation of the essential code snippets used in this project, read [Presence](https://docs-beta.agora.io/en/signaling/develop/presence?platform=ios)
